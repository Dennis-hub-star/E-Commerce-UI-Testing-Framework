...
public class APIUtilities {
	...
	public static RequestSpecification requestSpecification() throws IOException {
		...
		String token = UiUtilities.getGlobalVariables("token", filePath);
		...
		RequestSpecification builder = new RequestSpecBuilder()
				.setBaseUri(UiUtilities.getGlobalVariables("base_url", filePath)).addHeaders(headers).build();
	...
	public static Map<String, String> getPathParams(String repoName) throws IOException {
		...
		pathParams.put("owner", UiUtilities.getGlobalVariables("owner", filePath)); // Replace with actual username
